...
CREATE TABLE IF NOT EXISTS devices (
    ...
    status ENUM('active', 'inactive', 'maintenance', 'offline', 'displaced', 'damaged') DEFAULT 'active',
    description TEXT,
...
CREATE TABLE IF NOT EXISTS maintenance_logs (
    ...
    maintenance_type ENUM('calibration', 'repair', 'replacement', 'cleaning', 'inspection') NOT NULL,
    notes TEXT,
